...
<head>
    <meta charset="utf-8">
    <title>DEPOSTOK - Logo Ekleme</title>
...
<div id="content">
    ...
    <fieldset style="margin-left: 600px"><p><?php
            ...
            ?>
            <br> <br> <br> <a href="index.php" class="button blue round side-content">AnaSayfa</a>
        <?php
        } else {
            $data = "Cevap Yanlış";
        ...
        echo "</p></fieldset>";
            ...
            <form action="forget_pass.php" method="POST" id="login-form" class="cmxform" enctype="multipart/form-data">
                Şifre kurtarma cevabınız nedir?
                ...
                <a href="index.php" class="button blue round side-content">AnaSayfa</a>
            </form>
            </fieldset>
        <?php } ?>
...
<!-- FOOTER halil
    ...
    -->
    <p>Problem ve sorularınız için<a href="mailto:halil.mutlu@outlook.com?subject=Stok%20Yönetim%20Sistemi">halil.mutlu@outlook.com</a>.
    </p>
