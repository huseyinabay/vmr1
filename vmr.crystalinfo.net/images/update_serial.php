    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#form1").validate({
                ...
                messages: {
                    supplier: {
                        required: "Lütfen Tedarikçi Girin"
                    },
                    stockid: {
                        required: "Lütfen Stok Numarasý Girin"
                    },
                    grand_total: {
                        required: "Ürün Ekle"
                    },
                    bill_no: {
                        required: "Lütfen Fiþ Numarasýný Girin",
                        minlength: "Fiþ Numarasý en az 3 karakterden oluþmak zorundadýr"
                    }
                }
            });
...
//alert(parseFloat(document.getElementById('posnic_total').value));
        ...
        function unique_check() {
            if (!document.getElementById(document.getElementById('guid').value) || document.getElementById('edit_guid').value == document.getElementById('guid').value) {
                ...
                alert("Bu ürün bu satýnalma için daha önceden eklenmiþ");
...
<div id="header-with-tabs">
    ...
    <div class="page-full-width cf">
        ...
        <ul id="tabs" class="fl">
            ...
            <li><a href="view_sales.php" class="sales-tab">Satýþlar</a></li>
            <li><a href="view_customers.php" class=" customers-tab">Müþteriler</a></li>
            <li><a href="view_purchase.php" class="purchase-tab">Satýnalma</a></li>
            <li><a href="view_supplier.php" class=" supplier-tab">Tedarikçiler</a></li>
            <li><a href="view_product.php" class=" stock-tab">Stoklar / Ürünler</a></li>
            <li><a href="view_payments.php" class="payment-tab">Ödemeler / Borçlar</a></li>
...
<div id="content">
    ...
    <div class="page-full-width cf">
        ...
        <div class="side-menu fl">
            ...
            <h3>Satýnalma Yönetimi</h3>
            <ul>
                <li><a href="add_purchase.php">Satýnalma Ekle</a></li>
                <li><a href="view_purchase.php">Satýnalmalarý Göster </a></li>
            </ul>
        ...
        <div class="side-content fr">
            ...
            <div class="content-module">
                ...
                <div class="content-module-heading cf">
                    ...
                    <h3 class="fl">Satýnalma Güncelle</h3>
                    <span class="fr expand-collapse-text">Daraltmak için týkla</span>
                    <span class="fr expand-collapse-text initial-expand">Geniþletmek için týkla</span>
                ...
                <div class="content-module-main cf">
                    ...
                    if (isset($_POST['supplier']) and isset($_POST['stock_name'])) {
                        ...
                        echo "<br><font color=green size=+1 >Satýnalma bilgileri güncellenmiþtir Ref: [ $autoid] !</font>";
                    ...
                    <form name="form1" method="post" id="form1" action="">
                        ...
                        <table class="form" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td><span class="man">*</span>Tedarikçi:</td>
                                <td><input name="supplier" placeholder="TEDARÝKÇÝ GÝR" type="text" id="supplier"
                                           value="<?php echo $line->stock_supplier_name; ?> " maxlength="200"
                                           class="round default-width-input" style="width:130px "/></td>


                                <td><span class="man">*</span>Fiþ&nbsp;No:</td>
                                <td><input name="bill_no" placeholder="FÝÞ NO GÝR" type="text" id="bill_no"
                            ...
                            <tr>
                                ...
                                <td>Addres:</td>
                                <td><input name="address" placeholder="ADRES GÝR" type="text"
				...
				<td>Ýlçe:</td>
                                <td><input name="district" placeholder="ÝLÇE GÝR" type="text"
				...
				<td>Ýl:</td>
                                <td><input name="province" placeholder="ÝL GÝR" type="text"
                                ...
                                <td>Yetkili:</td>
                                <td><input name="contact" placeholder="YETKÝLÝ GÝR" type="text"
                                ...
                                <td>Telefon:</td>
                                <td><input name="phone" placeholder="TELEFON GÝR" type="text"
                        ...
                        <table class="form">
                            <tr>
                                <td> &nbsp;</td>
                                <td>Ödeme:<input type="text" class="round" value="<?php echo $line->payment; ?>"
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="mode">
                                        ...
                                        <option value="cheque">Diðer</option>
                                    </select>
                                </td>
                                <td>
                                    Bitiþ Tarihi:<input type="text" name="due" id="test2"
    ...
    <!-- FOOTER -->
    <div id="footer">
        <p>Sorularýnýz için <a href="mailto:halil.mutlu@outlook.com?subject=Stok%20Yönetim%20Sistemi">halil.mutlu@outlook.com</a>.
        </p>
