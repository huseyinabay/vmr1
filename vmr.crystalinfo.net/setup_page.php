...
// Execute query
  ...
  `customer_phone1` varchar(100) NOT NULL,
...
// Execute query
    ...
    if ($dummy === 1) {
        $sql = "INSERT INTO `customer_details` (`id`, `customer_name`, `customer_address`, `customer_contact1`, `customer_phone1`, `balance`) VALUES
...
// Execute query
  ...
  `supplier_phone1` varchar(100) NOT NULL,
  `balance` int(11) NOT NULL,
  PRIMARY KEY (`id`)
...
// Execute query
    ...
    if ($dummy === 1) {
        $sql = "INSERT INTO `supplier_details` (`id`, `supplier_name`, `supplier_address`, `supplier_contact1`, `supplier_phone1`, `balance`) VALUES
