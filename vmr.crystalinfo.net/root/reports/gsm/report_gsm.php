...
<table cellpadding="0" cellspacing="0" align="center" border="0" width="98%">
  ...
  <tr>
    ...
    <?table_header("GSM Raporları","100%");?>
    <center>
      <table cellpadding="0" cellspacing="0" align="center" border="0" width="100%">
        <tr height="22"> 
        <td width="10%"><input type="radio" class="input1" name="gsm_rep" value="opt" onclick="javascript:set_me('opt')"></td>      
        <td width="90%" class="td1_acik" id="opt"><b>Operatörlere</b> Göre Çağrılar</td>
      </tr>
      <tr height="22"> 
      ...
      <tr height="22">
        ...
        <td width="90%" class="td1_acik" id="max_num">En Fazla<b> Aranan GSM Numaraları</b></td>
      </tr>    
      <tr height="22"> 
        <td width="10%"><input type="radio" class="input1" name="gsm_rep" value="max_dep" onclick="javascript:set_me('max_dep')"></td>      
        <td width="90%" class="td1_acik" id="max_dep">En Fazla <b>GSM Çağrısı Yapan Departmanlar</b></td>
             </tr>
      <tr height="22">
        <td width="10%"><input type="radio" class="input1" name="gsm_rep" value="gsm_div" onclick="javascript:set_me('gsm_div')"></td>      
        <td width="90%" class="td1_acik" id="gsm_div">Çağrıların <b>GSM Kodlarına</b> Dağılımı</td>
             </tr>
                <!--<tr> 
