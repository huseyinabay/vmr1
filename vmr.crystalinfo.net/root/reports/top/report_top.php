    ...
    <td width="50%">
      ...
      <center>
        ...
        <tr height="22">
          ...
          <td width="90%" class="td1_acik" id="call_duration_ext">En <b>Uzun Süre Görüşme Yapan Dahililer</b></td>
        </tr>    
        <tr height="22"> 
          ...
          <td width="90%" class="td1_acik" id="call_duration_number">En <b>Uzun Süre Görüşülen Numaralar</b></td>
               </tr>
        <tr height="22">
          ...
          <td width="90%" class="td1_acik" id="call_amount_city">En Fazla <b>Aranan İller</b></td>
               </tr>
        <tr height="22">
        ...
        <tr height="22"> 
          ...
          <td width="90%" class="td1_acik" id="call_amount_time">En Fazla <b>Arama Yapılan Saatler</b></td>
        </tr>
        <tr height="22">
          ...
          <td width="90%" class="td1_acik" id="call_amount_gsm">En Fazla <b>Arama Yapılan GSM Operatörleri</b></td>
        </tr>
         <tr height="22">  
          ...
          <td width="90%" class="td1_acik" id="call_amount_gsm_number">En Fazla <b>Aranan GSM Numaraları</b></td>
             </tr>
        <tr height="22">  
          ...
          <td width="90%" class="td1_acik" id="call_amount_auth">En Fazla <b>Arama Yapan Otorizasyon Kodları</b></td>
             </tr><!--
                <tr> 
        ...
        <tr align="left">
          <td colspan="1" align="left" class="td1_koyu">Tarih:&nbsp&nbsp
            ...
            <option  value="e">Tarih Seç</option>
                  ...
                  <span width="45%" style="color: #1B4E81; margin-left: 5%;"><b>KVKK Uyumu</b>
               <input type="checkbox" name="KVKK" VALUE="1" style="margin-left: 5%;" size="15"></span></td>
               </td>
        </tr>
        <tr height="60">
          <td colspan="7">
