...
$query1 = "SELECT COUNT(CDR_MAIN_DATA.CDR_ID) AS y,
              ...
              WHERE ERR_CODE = 0 AND CALL_TYPE = 1 AND MY_DATE BETWEEN '$t0' AND '$t1' AND CDR_MAIN_DATA.LocationTypeid ='1' AND CDR_MAIN_DATA.SITE_ID='$SITE_ID' ".$usr_crt."
              GROUP BY CDR_MAIN_DATA.LocalCode
