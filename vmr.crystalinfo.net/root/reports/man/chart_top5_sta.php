...
$query1 = "SELECT COUNT(CDR_MAIN_DATA.CDR_ID) AS y,
            ...
            FROM CDR_MAIN_DATA
            INNER JOIN EXTENTIONS ON CDR_MAIN_DATA.ORIG_DN=EXTENTIONS.EXT_NO AND CDR_MAIN_DATA.SITE_ID = EXTENTIONS.SITE_ID
            WHERE ERR_CODE = 0 AND CALL_TYPE = 1 AND MY_DATE BETWEEN '$t0' AND '$t1' AND CDR_MAIN_DATA.SITE_ID='$SITE_ID' ".$usr_crt."
...
?>;
/*
var adet = adet.replace(/"/g, "");
var adet = adet.replace(/label:/g, "label:\"");
var adet = adet.replace(/}/g, "\"}");



var sure = sure.replace(/"/g, "");
var sure = sure.replace(/label:/g, "label:\"");
var sure = sure.replace(/}/g, "\"}");


var price = price.replace(/"/g, "");
var price = price.replace(/label:/g, "label:\"");
var price = price.replace(/}/g, "\"}");
