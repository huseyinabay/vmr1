...
-->
           <tr id=div1> 
               ...
               <td width="55%"><input type="checkbox" name="forceMainTable" VALUE="1" size="15">
               <span width="45%" style="color: #1B4E81; margin-left: 20%;"><b>KVKK Uyumu</b></span>
               <input type="checkbox" name="KVKK" VALUE="1" style="margin-left: 10%;" size="15"></td>
           </tr>
      </table>
    <?table_footer();?>
  </td>
  ...
  <tr>
        <td colspan=4 align=center><br>
            <a href="javascript:submit_form('outb_search') , history.go(0);"><img name="Image631" border="0" src="<?=IMAGE_ROOT?>raporal.gif"></a>
       </td>
    </tr>    
</table>    
   </form>
