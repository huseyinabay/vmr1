...
<table cellpadding="0" cellspacing="0" align="center" border="0" width="98%">
  ...
  <tr>
    ...
    <?table_header("Gelen Çağrı Raporu","100%");?>
    <center>
      <table cellpadding="0" cellspacing="0" align="center" border="0" width="100%">
        <tr> 
          <td width="60%" class="td1_koyu">Numarası Olanlar</td>
          <td width="40%" align="left"><input class="input1" type="checkbox" name="show_clid" value="1"></td>
        </tr>
		<tr> 
          <td width="60%" class="td1_koyu">Cevapsız Çağrılar</td>
          <td width="40%" align="left"><input class="input1" type="checkbox" name="abandon" value="1"></td>
        </tr>
		<tr> 
          <td width="60%" class="td1_koyu">Cevaplananlar</td>
          <td width="40%" align="left"><input class="input1" type="checkbox" name="ansvered" value="1"></td>
        </tr>
        <tr> 
		...
		<tr> 
          <td class="td1_koyu">Hat No</td>
          <td ><input class="input1" type="text" name="ORIG_TRUNK_MEMBER" VALUE="<?echo $ORIG_TRUNK_MEMBER?>" size="30"></td>
        </tr>
        <tr> 
        ...
        <tr>
          <!--
        <td  width="100%" class="td1_koyu">Çıktı Formatı</td>
               <td width="50%">
                <input type="radio" name="CSV_EXPORT" VALUE="0" size="10" CHECKED>Html
              
                <input type="radio" name="CSV_EXPORT" VALUE="1" size="15">Csv 
             
                <input type="radio" name="CSV_EXPORT" VALUE="2" size="18">Excel
                </td>
              -->
         </tr>
  ...
  <tr>
    <td colspan=4 align=center><br>
     <a href="javascript:submit_form('inb_search'), history.go(0) ;" ><img name="Image631" border="0" src="<?=IMAGE_ROOT?>raporal.gif"></a>
    </td>
  </tr>    
</table>    
</form>
