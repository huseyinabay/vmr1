<?
  ...
  echo "<center>";
     page_header();
?>
<form name="outb_search" method="post" action="archieve_report_prn.php?act=src">
...
<table cellpadding="0" cellspacing="0" align="center" border="0" width="98%">
  ...
  <tr>
    ...
    <center>
      ...
      <tr> 
       ...
       <tr> 
        <td width="45%" class="td1_koyu">Fihrist </td>
               <td width="55%">
       ...
       <tr id="" style=""> 
        ...
        <tr> 
               <td width="45%" class="td1_koyu">Şifreli Çıkışlar</td>
               <td width="55%">
                <input type="radio" name="AUTH_CODE_CNTL" VALUE="1" size="15">Şifreli
                <input type="radio" name="AUTH_CODE_CNTL" VALUE="2" size="15">Şifresiz
                <input type="radio" name="AUTH_CODE_CNTL" VALUE="0" size="15" CHECKED>Tümü
                </td>
           </tr>
           <tr id=div1> 
  ...
  <td nowrap width="48%" valign="top">
          ...
          <table>
            <tr id="tarih_bas" style="display:none;"> 
              ...
              <td width="50%" colspan="6">
                  <input type="text" size=17 name="t0" VALUE="<?echo $t0?>" readonly><a href="javascript://"><img align="absmiddle" src="<?=IMAGE_ROOT?>takvim_icon.gif" onclick="javascript:show_calendar(document.all('t0').name,null,null,null,event.screenX,event.screenY,1);" border="0"></a>
              </td>
            </tr>
    ...
    <table>
      ...
      <tr>
        <td class="td1_koyu">
                    - Control tuşuna basarak birden fazla departman seçebilisiniz!!!
        </td>
      </tr>
      <?}?>
    </table>
...
//Time functions starts here
  function Fillothercombos(my_val){
    ...
    FillSecondCombo('TRUNK_ID',     'TRUNK_NAME',   '10SITE_ID='+ my_val               , ''                   , 'TRUNK_ID' , '');
  }
