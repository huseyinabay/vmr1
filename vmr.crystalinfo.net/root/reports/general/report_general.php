...
<table cellpadding="0" cellspacing="0" align="center" border="0" width="98%">
  ...
  <tr>
    ...
    <center>
      <table cellpadding="0" cellspacing="0" align="center" border="0" width="100%">
       <tr height="22"> 
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="general" onclick="javascript:set_me('general')"></td>
        <td width="95%" class="td1_acik" id="general">Çağrıların <b>Arama Türüne</b> Göre Dağılımları</td>
      </tr>
      <tr height="22"> 
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="ext" onclick="javascript:set_me('ext')"></td>
        <td width="95%" class="td1_acik" id="ext">Çağrıların Tutara Göre <b>Dahili Bazlı</b> Dağılımı</td>
      </tr>
       <tr height="22">  
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="ext_time" onclick="javascript:set_me('ext_time')"></td>
        <td width="95%" class="td1_acik" id="ext_time"><b>Dahililerin Arama Sürelerine</b> Göre Dağılımı</td>
           </tr>
      <tr height="22">
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="dept" onclick="javascript:set_me('dept')"></td>
        <td width="95%" class="td1_acik" id="dept">Çağrıların <b>Departmanlara</b> Göre Dağılımı</td>
      </tr>    
      <!--<tr height="22"> 
      ...
      <tr height="22"> 
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="matrix_pr" onclick="javascript:set_me('matrix_pr')"></td>
        <td width="95%" class="td1_acik" id="matrix_pr">Operatör <b>Şebeke Matrisi</b></td>
             </tr>
      <tr height="22">
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="nat" onclick="javascript:set_me('nat')"></td>
        <td width="95%" class="td1_acik" id="nat"><b>Şehirlerarası</b> Çağrıların İllere Dağılımı</td>
             </tr>
      <tr height="22">
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="int" onclick="javascript:set_me('int')"></td>
        <td width="95%" class="td1_acik" id="int"><b>Uluslararası</b> Çağrıların Ülkelere Dağılımı</td>
      </tr>
      <tr height="22"> 
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="hour" onclick="javascript:set_me('hour')"></td>
        <td width="95%" class="td1_acik" id="hour">Çağrıların <b>Günün Saatlerine</b> Göre Dağılımı</td>
      </tr>
       <tr height="22">  
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="dept_time" onclick="javascript:set_me('dept_time')"></td>
        <td width="95%" class="td1_acik" id="dept_time"><b>Departmanların Arama Sürelerine</b> Göre Dağılımı</td>
           </tr>
      <tr height="22">
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="day" onclick="javascript:set_me('day')"></td>
        <td width="95%" class="td1_acik" id="day">Çağrıların <b>Ayın Günlerine</b> Göre Dağılımı</td>
      </tr>
      <tr height="22">
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="month" onclick="javascript:set_me('month')"></td>
        <td width="95%" class="td1_acik" id="month">Çağrıların <b>Yılın Aylarına</b> Göre Dağılımı</td>
      </tr>
      <tr height="22">  
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="auth" onclick="javascript:set_me('auth')"></td>
        <td width="95%" class="td1_acik" id="auth">Çağrıların <b>Otorizasyon Kodlarına</b> Göre Dağılımı</td>
      </tr>
	        <tr height="22">  
        <td width="5%"><input type="radio" class="input1" name="general_rep" value="ext_all" onclick="javascript:set_me('ext_all')"></td>
        <td width="95%" class="td1_acik" id="ext_all"><b>Gelen Ve Giden</b> Çağrıların Özet Raporu</td>
      </tr>
      <!--
      <tr> 
        <td colspan="2">
        <table border=0 width="100%" cellspacing=0 cellpadding=0>
          <tr>
            ...
            <td width="16%"><input type="radio" name="CSV_EXPORT" VALUE="0" size="13" CHECKED>Html</td>
            <td width="25%"><input type="radio" name="CSV_EXPORT" VALUE="1" size="13">Csv</td>
            <td width="30%"><input type="radio" name="CSV_EXPORT" VALUE="2" size="13">Excel Export</td>
          </tr>
        </table>        
        </td>
      <tr>
  -->
        <td width="5%"><image id=DivImg  src=/images/arti.gif onclick="openDiv(this)"  value="eksi"></td>
        <td width="95%" class="td1_koyu"></td>
      </tr>
      <tr id=div1>
        <td width="5%"><input type="radio" class="cache1" name="withCache" value="DBwriteCache" CHECKED></td>
        <td width="95%" class="td1_koyu">Veritabanından Al Hızlı Hafızaya Yaz</td>
      </tr>
      <tr id=div2>
        <td width="5%"><input type="radio" class="cache1"name="withCache" value="DBnotCache"></td>
        <td width="95%" class="td1_koyu">Veritabanından Al Hızlı Hafızaya Yazma</td>
      </tr>
      <tr id=div3>
        <td width="5%"><input type="radio" class="cache1" name="withCache" value="callCache" ></td>
        <td width="95%" class="td1_koyu">Hızlı Hafızadan Çağır</td>
      </tr>
      <tr id=div4> 
        <td width="5%"><input type="checkbox" name="forceMainTable" VALUE="1" size="15"></td>
  ...
  <td nowrap width="48%" valign="top">
    ...
    <table cellspacing="0" cellpadding="0" border="0">
	  ...
	  <tr> 
		  <td colspan="1" class="td1_koyu">Departman</td>
        <td colspan="6" class="td1_acik" colspan=1>
...
//Time functions ends here
    ...
    function set_me(mytype){
      ...
      if(mytype=='ext' || mytype=='ext_time' || mytype=='ext_all'){
  ...
  function submit_form(){
    ...
    if (mytype=='matrix_pr'){
        ...
        document.all('general_search').target= 'report_screen';
        document.all('general_search').submit();
    } else if(mytype=='ext_all'){
		document.all('general_search').target= 'report_screen';
        document.all('general_search').action = 'report_all_ext.php?act=src&type=' + mytype;
        document.all('general_search').submit();
	}else{
        document.all('general_search').target= 'report_screen';
