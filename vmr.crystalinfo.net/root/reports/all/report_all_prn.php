...
<?}else{
    if($AUTH_CODE_CNTL==1){?>
                    <td class="rep_table_header" width="20%" ALIGN="center">Auth Code<a style="cursor:hand;" onclick="javascript:submit_form('Dahili');"><img src="http://<?=$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']?><?=IMAGE_ROOT?><?=($order=="auth")?$sort_gif:"sort.gif"?>" align="absmiddle" Title="Ada Göre Sırala"></a></td>
  <?}else{?>
                    <td class="rep_table_header" width="20%" ALIGN="center">Dahili<a style="cursor:hand;" onclick="javascript:submit_form('Dahili');"><img src="http://<?=$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']?><?=IMAGE_ROOT?><?=($order=="Dahili")?$sort_gif:"sort.gif"?>" align="absmiddle" Title="Dahiliye Göre Sırala"></a></td>
  <?}?>                    
                    <td class="rep_table_header" width="15%" ALIGN="center">Departman<a style="cursor:hand;" onclick="javascript:submit_form('Departman');"><img src="http://<?=$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']?><?=IMAGE_ROOT?><?=($order=="Departman")?$sort_gif:"sort.gif"?>" align="absmiddle" Title="Departmana Göre Sırala"></a></td>
                    ...
                    <td class="rep_table_header" width="10%" ALIGN="center">Sure<a style="cursor:hand;" onclick="javascript:submit_form('sure');"><img src="http://<?=$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']?><?=IMAGE_ROOT?><?=($order=="sure")?$sort_gif:"sort.gif"?>" align="absmiddle" Title="Süreye Göre Sırala"></a></td>
                    ...
                    <td class="rep_table_header" width="15%" ALIGN="center">Aranan</td>
                    <td class="rep_table_header" width="12%" ALIGN="center">Ucret<a style="cursor:hand;" onclick="javascript:submit_form('ucret');"><img src="http://<?=$_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']?><?=IMAGE_ROOT?><?=($order=="ucret")?$sort_gif:"sort.gif"?>" align="absmiddle" Title="Tutara Göre Sırala"></a></td>
<?}?>
                </tr>
                <tr>
