<?
  ...
  if ($SITE_ID<>'-1' && $SITE_ID<>""){
    ...
    $sql_str = "SELECT ALERT_DEF_NAME, ALERT_DEF_ID, SITE_ID FROM ALERT_DEFS 
        WHERE ALERT_DEFS.ALERT_ID = 8 ".$site_crt;
...
?>
<center>
<a href="month_summary_alert.php?act=new"><img border="0" src="<?=IMAGE_ROOT?>yeni_kayit.gif" style="cursor:hand;"></a>
...
<? 
   ...
   while($row = mysqli_fetch_object($result)){
      ...
      echo " <td height=\"20\">$row->ALERT_DEF_ID</td> ".CR;
       ...
       echo " <td><a HREF=\"month_summary_alert.php?act=upd&id=$row->ALERT_DEF_ID\">Güncelle</td>".CR;
         echo "</tr>".CR;
       list_line(18);
   }
?>
