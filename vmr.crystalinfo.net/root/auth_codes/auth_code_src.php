...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr class="header_beyaz">
        ...
        <td><a href="javascript:submit_form('auth_code_src',1, 'SITES.SITE_NAME')">Site Adı</a></td>        
        <td><a href="javascript:submit_form('auth_code_src',1, 'AUTH_CODES.AUTH_CODE')">Auth.Kodu</a></td>
        <td><a href="javascript:submit_form('auth_code_src',1, 'AUTH_CODES.AUTH_CODE_DESC')">Açıklama</a></td>
        <td>Güncelle</td>
    </tr>
<? 
   $i;
...
<table width="80%" align="center">
    <tr>
        <td align="center">
        <?
        echo $cdb->get_paging($pageCount, (int)$p, "auth_code_src", $ORDERBY);
        ?></td>
    </tr>
</table>
<?page_footer(0);?>
