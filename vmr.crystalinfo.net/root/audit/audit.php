<? require_once $_SERVER['DOCUMENT_ROOT']."/cgi-bin/functions.php";
  ...
  //Admin Hakkı versa ve Site Admin hakkı yoksa sadece kendi sitesine ait bilgiyi görebilmeli
     if (right_get("ADMIN")){
         $site_crt = "SITE_ID = ".$_SESSION['site_id'];
  }
...
<table cellspacing="0" cellpadding="0" border="0" width="90%" >
  <tr>
      ...
      <table cellspacing="0" cellpadding="0" border="0">
        <?
        //Sorgulamalar içinde bulunulan ay için yapılacaktır
        $t0 = date("Y-m-01");
        $t1 = date("Y-m-d");
...
//echo $local_country_code;	   
        //Giriş Hattı Olarak Tanımlanmış Hatlardan Çıkış alınması Anormal Durumu
        ...
        ?>
        <tr>
          <td width="80%" class="td1_koyu" style="cursor:hand;" onclick="open_div('result_trout')">Giriş Hatlarından Çağrı Yapılması</td>
          <td width="10%" align="right" class="td1_koyu"><?if (mysqli_num_rows($result_trout)>0){echo "<b>VAR</b>"; }else{ echo "YOK";}?></td>
        ...
        <?      
        //Çıkış Olarak Tanımlanmış Hatlara Çağrı Düşmesi Durumu
        ...
        ?>
        <tr>
          <td width="80%" class="td1_koyu" style="cursor:hand;" onclick="open_div('result_trin')">Çıkış Hatlarına Çağrı Gelmesi
          <td width="10%" align="right" class="td1_koyu"><?if (mysqli_num_rows($result_trin)>0){echo "<b>VAR</b>"; }else{ echo "YOK";}?></td>
        ...
        <?      
        //Telekom Hattından Cep Tel Aramaları
        ...
        ?>
        <tr>
          <td width="80%" class="td1_koyu" style="cursor:hand;" onclick="open_div('result_fct')">Telekom Hatlarından GSM Çağrısı</td>
          <td width="10%" align="right" class="td1_koyu"><?if (mysqli_num_rows($result_fct)>0){echo "<b>VAR</b>"; }else{ echo "YOK";}?></td>
        ...
        <?      
        //GSM Aramalarında Operatör Farklılıkları
        ...
        ?>
        <tr>
          <td width="80%" class="td1_koyu" style="cursor:hand;" onclick="open_div('result_opt')">Verimsiz GSM Operatör Kullanımı</td>
          <td width="10%" align="right" class="td1_koyu"><?if (mysqli_num_rows($result_opt)>0){echo "<b>VAR</b>"; }else{ echo "YOK";}?></td>        
        ...
        <?      
        //Tanımlanmamış Trunklara Çağrı Gelmesi
        ...
        $cdr_route_cnt = mysqli_num_rows($result);
        $cdr_route_cnt2 = mysqli_num_rows($result2);
        $i=0;
        ...
        $sys_route_cnt = mysqli_num_rows($result1);
	    ...
	    ?>     
        <tr>
          <td width="80%" class="td1_koyu" style="cursor:hand;" onclick="open_div('non_matching_trunk')">CrystalInfo Sisteminde Kayıtlı Olmayan Hatlara Çağrı</td>
        ...
        <?  
        //Tanımlanmamış Dahililere Çağrı Gelmesi
        ...
        $sql_str2 = "SELECT ORIG_DN FROM CDR_MAIN_DATA 
		...
		?>     
        <tr>
          <td width="80%" class="td1_koyu" style="cursor:hand;" onclick="open_div('non_matching_dn')">CrystalInfo Sisteminde Kayıtlı Olmayan Dahililerde Çağrı</td>
        ...
        <?
        //Yarım Saat'ten Fazla Tutan Konuşmalar
        ...
        ?>
        <tr>
          <td width="80%" class="td1_koyu" style="cursor:hand;" onclick="open_div('result_time')">Yarım Saatten Fazla Süren Konuşmalar</td>
      ...
      <?table_header("Detaylar","60%")?>
        ...
        <div id="result_trout" style="display:none;">
          <table>
            ...
            <?while ($row = mysqli_fetch_object($result_trout)){?>   
                <tr>
        ...
        <div id="result_trin" style="display:none;">
          <table>
            ...
            <?while ($row = mysqli_fetch_object($result_trin)){?>   
                <tr>
              <td width="20%" align="center" class="td1"><a href="#"><span onclick="javascript:popup('cdr_detail.php?id=<?=$row->CDR_ID?>','audit',600,300)"><?=$row->CDR_ID?></span></a></td>
                   <td colspan="3" width="80%" align="center" class="td1"><?=$row->CDR_TRUNK?></td>
                </tr>
        ...
        <div id="result_fct" style="display:none;">
          <table>
            <tr>
              <td width="20%" align="center" class="td1_koyu">Kayıt No</td>
        ...
        <div id="result_opt" style="display:none;">
          <table>
            <tr>
              <td width="15%" align="center" class="td1_koyu">Kayıt No</td>
              <td width="10%" align="center" class="td1_koyu">Dahili</td>
              <td width="20%" align="center" class="td1_koyu">Çıkış Hattı</td>
              <td width="25%" align="center" class="td1_koyu">Aranan Yer</td>
              <td width="30%" align="center" class="td1_koyu">Telefon</td>
            </tr>
            <?while ($row = mysqli_fetch_object($result_opt)){?>   
                <tr>
        ...
        <div id="result_time" style="display:none;">
          <table>
            ...
            <?while ($row = mysqli_fetch_object($result_time)){?>   
            <tr>
              <td width="15%" align="center" class="td1"><a href="#"><span onclick="javascript:popup('cdr_detail.php?id=<?=$row->CDR_ID?>','audit',600,300)"><?=$row->CDR_ID?></span></a></td>                                      
              <td width="20%" align="center" class="td1"><?=$row->ORIG_DN?></td>
