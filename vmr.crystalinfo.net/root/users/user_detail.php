<?
 ...
 //Kişinin 1. Dahilisine Yapılan Kota Atamaları alınıyor
...
//Kişinin 2. Dahilisine Yapılan Kota Atamaları alınıyor
   $sql_str = "SELECT QUOTAS.INCITY_LIMIT,QUOTAS.INTERCITY_LIMIT,
          QUOTAS.GSM_LIMIT, QUOTAS.INTERNATIONAL_LIMIT
        FROM QUOTA_ASSIGNS
          LEFT JOIN QUOTAS ON QUOTA_ASSIGNS.QUOTA_ID = QUOTAS.QUOTA_ID
...
//Kişinin 3. Dahilisine Yapılan Kota Atamaları alınıyor
   $sql_str = "SELECT QUOTAS.INCITY_LIMIT,QUOTAS.INTERCITY_LIMIT,
          QUOTAS.GSM_LIMIT, QUOTAS.INTERNATIONAL_LIMIT
        FROM QUOTA_ASSIGNS
          LEFT JOIN QUOTAS ON QUOTA_ASSIGNS.QUOTA_ID = QUOTAS.QUOTA_ID
...
//Authorisation koduna yapılan kota ataması
   $sql_str = "SELECT QUOTAS.INCITY_LIMIT,QUOTAS.INTERCITY_LIMIT,
          QUOTAS.GSM_LIMIT, QUOTAS.INTERNATIONAL_LIMIT
        FROM QUOTA_ASSIGNS
          LEFT JOIN QUOTAS ON QUOTA_ASSIGNS.QUOTA_ID = QUOTAS.QUOTA_ID
...
//Departmanındaki Her bir elemana yapılan Kota Atamaları alınıyor.
...
<table width="90%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <?table_header("Kişisel Bilgiler ","90%");?>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
          <td class="td1_koyu" width="10%">Adı</td>
          <td class="td1" width="25%"><?echo $row->NAME?></td>
          <td class="td1_koyu" width="15%">Soyadı</td>
  ...
  <tr>
    ...
    <?table_in_table_header($row->EXT1." Dahilisinin Kotası","95%");?>
    ...
    <?if ($QUOTA_EXT2=="Yes"){?>  
    <td width="30%" align="center"><br>
      <?table_in_table_header($row->EXT2." Dahilisinin Kotası","95%");?>
        <table border="0" cellspacing="2" cellpadding="1" align="center" width="100%">
                   <tr>
                       <td class="bg_acik_f_koyu" width="35%">Kota Adı</td>
                        <td class="bg_acik_f_acik"width="65%"><? echo $row->QUOTA_NAME; ?></td>
    ...
    <?if ($QUOTA_EXT3=="Yes"){?>      
    <td width="30%" align="center"><br>
      <?table_in_table_header($row->EXT3." Dahilisinin Kotası","95%");?>
        <table border="0" cellspacing="2" cellpadding="1" align="center" width="100%">
                   <tr>
                       <td class="bg_acik_f_koyu" width="35%">Kota Adı</td>
                        <td class="bg_acik_f_acik"width="65%"><? echo $row->QUOTA_NAME; ?></td>
  ...
  <tr>  
    <?if ($QUOTA_AUTH=="Yes"){?>    
    <td width="30%" align="center"><br>
      <?table_in_table_header($row->AUTH_CODE." Kodunun Kotası","95%");?>
        <table border="0" cellspacing="2" cellpadding="1" align="center" width="100%">
                   <tr>
                       <td class="bg_acik_f_koyu" width="35%">Kota Adı</td>
                        <td class="bg_acik_f_acik"width="65%"><? echo $row->QUOTA_NAME; ?></td>
    ...
    <td width="30%" align="center"><br>
      <?table_in_table_header("Departmanının Kotası","95%");?>
        <table border="0" cellspacing="2" cellpadding="1" align="center" width="100%">
                   <tr>
                       <td class="bg_acik_f_koyu" width="35%">Kota Adı</td>
                        <td class="bg_acik_f_acik"width="65%"><? echo $row->QUOTA_NAME; ?></td>
