<?php
    ...
    $titleObj = $c->addTitle(turkish2utf(" Son 10 Günün Çağrı Özeti "), "verdana.ttf", 10,0xffffff);
...
//  $legendObj->setBackground(0x9cbade, -1, 0xffffff);
    ...
    #border.
    //$titleObj = $c->addTitle(turkish2utf("Son Bir Hafta Konuşma Ücretleri"), "verdana.ttf", 10, 0x2C5783 );
