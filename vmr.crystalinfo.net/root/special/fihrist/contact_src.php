 ...
 <form name="contact_search" method="post" action="contact_src.php?act=src">
   ...
   <center>
     <table cellpadding="0" cellspacing="0" ALIGN="center" border="0" width="65%">      
       ...
       <tr> 
         <td class="font_beyaz" width="25%">Dahili İş Tel</td>
       ...
       <tr> 
         <td class="font_beyaz" width="25%">Harici İş Tel</td>
       ...
       <tr> 
         <td class="font_beyaz" width="25%">Kişisel E-Mail</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr class="header_beyaz">
        ...
        <td width="15%"><a href="javascript:submit_form('contact_search',1, 'NAME')">Adı</a></td>
        <td width="15%"><a href="javascript:submit_form('contact_search',1, 'SURNAME')">Soyadı</a></td>
        <td width="15%"><a href="javascript:submit_form('contact_search',1, 'PERSONAL_EMAIL')">EMAIL</a></td>
        <td width="15%"><a href="javascript:submit_form('contact_search',1, 'EXT_COMP_TEL')">Dahili İş Tel.</a></td>
