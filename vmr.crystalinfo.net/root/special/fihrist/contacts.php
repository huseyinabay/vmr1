...
<INPUT TYPE="hidden" value="<?=$id?>" name=id> 
     <tr class="form">
       ...
       <tr> 
           <td class="td1_koyu" width="25%">Ünvanı</td>
           <td width="75%">
       ...
       <tr> 
        ...
        <tr> 
            <td class="td1_koyu" width="25%">Dahili İş Tel</td>
        ...
        <tr> 
            <td class="td1_koyu" width="25%">Harici İş Tel</td>
  ...
  <table align="right" width="100%" border="0">
   ...
   <script language="javascript">
        form_fields[0] = Array ("NAME", "Adı alanını Giriniz.",  TYP_NOT_NULL);
        form_fields[1] = Array ("SURNAME", "Soyadı Alanını Giriniz.",  TYP_NOT_NULL );
