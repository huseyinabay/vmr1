...
<?if($CSV_EXPORT != 2){?>
  ...
  $sql_str="SELECT Locationid,LocationName FROM TLocation"; 
   ...
   if ($act == "src") {
      ...
      $kriter .= $cdb->field_query($kriter,   "CDR_MAIN_DATA.SITE_ID"     ,  "=",  "$SITE_ID"); //Bu mutlaka olmalı.ılgili siteyi belirliyor.
                    ...
                    <td width="50%">
                        ...
                        <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr <?if($hafta=="3") echo "style=\"display:none;\""?>>
                                <td class="rep_header" align="left" nowrap width="40%" colspan="2"><?=($hafta=="1")?"Hafta ıçi":"Hafta Sonu"?></td>
                            </tr>
                        ...
                        <?if($CSV_EXPORT<>2){?>
                          <table cellspacing=0 cellpadding=0>
                            <tr>
                              ...
                              <td><a href="javascript:history.forward(1);"><img src="<?=IMAGE_ROOT?>report/ileri.gif" border=0 title="ıleri"></a></td>
...
<?}else{
    if($AUTH_CODE_CNTL==1){?>
                    <td class="rep_table_header" width="30%" ALIGN="center">Auth Code<a style="cursor:hand;" onclick="javascript:submit_form('Dahili');"><img src="<?=IMAGE_ROOT?><?=($order=="auth")?$sort_gif:"sort.gif"?>" align="absmiddle" Title="Ada Göre Sırala"></a></td>
  <?}else{?>
                    <td class="rep_table_header" width="30%" ALIGN="center">Dahili<a style="cursor:hand;" onclick="javascript:submit_form('Dahili');"><img src="<?=IMAGE_ROOT?><?=($order=="Dahili")?$sort_gif:"sort.gif"?>" align="absmiddle" Title="Dahiliye Göre Sırala"></a></td>
  <?}?>                    
                    ...
                    <td class="rep_table_header" width="10%" ALIGN="center">Süre<a style="cursor:hand;" onclick="javascript:submit_form('sure');"><img src="<?=IMAGE_ROOT?><?=($order=="sure")?$sort_gif:"sort.gif"?>" align="absmiddle" Title="Süreye Göre Sırala"></a></td>
                    ...
                    <td class="rep_table_header" width="20%" ALIGN="center">Aranan</td>
                    <td class="rep_table_header" width="12%" ALIGN="center">Ücret<a style="cursor:hand;" onclick="javascript:submit_form('ucret');"><img src="<?=IMAGE_ROOT?><?=($order=="ucret")?$sort_gif:"sort.gif"?>" align="absmiddle" Title="Tutara Göre Sırala"></a></td>
