...
?>
<head>
 <link rel="stylesheet" type="text/css" href="../scripts/crystal.css" />
...
<table cellpadding="0" cellspacing="0" align="center" border="0" width="98%">
  ...
  <tr>
    ...
    <?table_header("Dahili Görüşme Raporu","100%");?>
    <center>
      <table cellpadding="0" cellspacing="0" align="center" border="0" width="100%">
        <tr> 
  ...
  <tr>
   ...
   <a href="report_local.php"><img border="0" src="<?=IMAGE_ROOT?>kriter_temizle.gif"></a>
<?page_footer(0);?>
