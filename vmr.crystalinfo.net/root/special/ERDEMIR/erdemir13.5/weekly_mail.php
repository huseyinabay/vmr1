...
/*       Rapor gönderilecek mail adreslerini çek       */    
     ...
     $sql_mail = "SELECT EMAIL AS TO_EMAIL, ACCOUNT_NO from ACCOUNT_EMAIL WHERE EMAIL <> '' LIMIT 360,30";
                 ...
                 echo "<table border=0 width=400>\n";
                     ...
                     if($CSV_EXPORT==1){
                        ...
                        while($rowd = mysqli_fetch_object($result)){
                          ...
                          if($old_account_no<>$rowd->ACCOUNT_NO){ 
                            echo "<tr>";
                            echo "<td colspan=5>*** Erdemir Resmi Gorusme Telefon Faturasi ***   	Hesap Kodu :".$rowd->ACCOUNT_NO."</td></tr><tr>\n";
                          }
                          if($old_ext_no<>$rowd->EXT_NO){ 
