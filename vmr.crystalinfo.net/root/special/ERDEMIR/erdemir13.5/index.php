...
page_header();
echo "<br>";
table_header("Müşteri Özel Bölümü","80%");?>
<center>
<table width="100%" border="1" cellspacing="0" cellpadding="0" height="100%">
  ...
  <tr>
    <td align="left" valign="middle"><li><a href="auth_code_src.php">Şifre Hesap  Arama</a></td>
  </tr>
  <tr>
    <td align="left" valign="middle"><li><a href="auth_mail_src.php">Hesap Maili Arama</a></td>
  </tr>
    <tr>
    <td align="left" valign="middle"><li><a href="report_local.php">Dahili Arama Detaylari</a></td>
  </tr>
  <tr>
    <td align="left" valign="middle"><br><br><br><li><a href="weekly_mail.php">Şifre Mailing (Test İçin) </a></td>
  </tr>
  <tr>
    <td align="left" valign="middle"><li><a href="weekly_pers_auth_mail.php">Kişisel Şifre Mailing (Test İçin) </a></td>
  </tr>

  <tr>
    <td align="left" valign="middle"><li>Test</td>
  </tr>
