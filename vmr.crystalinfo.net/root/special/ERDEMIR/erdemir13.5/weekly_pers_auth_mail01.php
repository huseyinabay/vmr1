                     ...
                     if($CSV_EXPORT==1){
                        ...
                        while($rowd = mysql_fetch_object($result)){
                          ...
                          if($old_ext_no<>$rowd->EXT_NO){ 
                            ...
                            if ($rowd->CountryCode == $local_country_code){
                                if ($rowd->LocalCode == $LOC_CODE || $rowd->LocalCode==""){//Þehiriçi Kabul edilen kod.
                                  $TEL_NUMBER = $LOC_CODE ." ".substr($rowd->PURE_NUMBER,0,7);
                                }else{
                                  $TEL_NUMBER = $rowd->LocalCode." ".substr($rowd->PURE_NUMBER,0,7);
                                }
                            }else{
