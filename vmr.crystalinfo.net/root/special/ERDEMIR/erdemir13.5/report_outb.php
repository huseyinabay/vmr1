<?	 session_cache_limiter('nocache');     // Halil 22092020 en üste alındı
...
<table cellpadding="0" cellspacing="0" align="center" border="0" width="98%">
  ...
  <tr>
    ...
    <center>
      <table cellpadding="0" cellspacing="0" align="center" border="0" width="100%">
        <tr> 
        <td width="45%" class="td1_koyu">Rapor Tipi</td>
               <td width="55%">
                <select name="rep_type" class="select1" style="width:200" >
                   <option value=1>Ayrıntı</option>
                   <option value=2>Özet</option>
                   <option value=3>Hesap Bazında</option>
                   <option value=4>Hesap Detay</option>                                                         
                </select>
                </td>
      </tr>
        <tr> 
        ...
        <tr> 
        <td width="45%" class="td1_koyu">Hesap No</td>
               <td width="55%"><input class="input1" type="text" name="ACCOUNT_NO" VALUE="<?echo $ACCOUNT_NO?>" size="30">
                </td>
      </tr>
      ...
      <tr> 
       ...
       <table border=0 width="100%" cellspacing=0 cellpadding=0>
        ...
        <td  width="29%" class="td1_koyu">Çıktı Formatı</td>
               ...
               <td width="25%">
                <input type="radio" name="CSV_EXPORT" VALUE="1" size="15">Text Export
                </td>
               <td width="30%">
        ...
        <td colspan="7">
          <table>
            <tr id="tarih_bas" style="display:none;"> 
                       <td width="50%" colspan="1" class="td1_koyu" tip="Tarih formatini uygun þekilde giriniz.">Baş. Tarihi:(gg/aa/yyyy)</td>
...
//Time functions ends here
  ...
  function submit_form(form_name){
        ...
        document.all(form_name).action = 'report_outb_prn.php?act=src';
        //alert(document.all('rep_type').value);
        if(document.all('rep_type').value==3)  document.all(form_name).action = 'report_account_prn.php?act=src';
        if(document.all('rep_type').value==4)  document.all(form_name).action = 'report_account_det_prn.php?act=src';
