<?  require_once $_SERVER['DOCUMENT_ROOT']."/cgi-bin/functions.php";
    ...
    if (right_get("SITE_ADMIN")){
      ...
      $usr_crt  = get_users_crt($_SESSION["user_id"],2,$_SESSION["site_id"]);
  ...
  $max_acc_dur =  get_site_prm('MAX_ACCE_DURATION',$SITE_ID);
   ...
   $report_type="Dahili Çağrı Raporu";

   if ($act == "src") {
    $kriter = "";

    //Temel kriterler. Verinini hızlı gelmesi için başa konuldu.
    $kriter .= $cdb->field_query($kriter,   "CDR_MAIN_LOCAL.SITE_ID"     ,  "=",  "$SITE_ID"); //Bu mutlaka olmalı.İlgili siteyi belirliyor.
    ...
    $kriter .= $cdb->field_query($kriter,   "CDR_MAIN_LOCAL.TER_DN"     ,  "<>",  "''"); //Bu mutlaka olmalı.Hatasız kayıt olduğunu gösteriyor.
...
//Aranan dahili kriteri oluşturuluyor.
   $in_str = "";
   if($TER_DN){
  ...
  //Arayan dahili kriteri oluşturuluyor.
   if($ORIG_DN){
...
//Raporlanması istenmeyen dahililer alınıyor
    ...
    <td width="100%" align="center" class="rep_header" align="center">
         <TABLE BORDER="0" WIDTH="100%">
            <TR>
              ...
              <TD width="50%" align=center CLASS="header"><?echo $company;?><BR>DAHİLİ GÖRÜŞME RAPORU</TD>
        ...
        <tr><td width="50%" class="rep_header" align="left">
          ...
          <table cellspacing=0 cellpadding=0>
            <tr>
              ...
              <td><a href="javascript:mailPage('inbound.html')"><img src="<?=IMAGE_ROOT?>report/mail.gif" border=0 title="Mail"></a></td>
...
<?           if($sort_type=="asc")
      ...
      <?
       ...
       $i++;
       $csv_data[$i][4] = "Toplam Görüşme Adedi";
