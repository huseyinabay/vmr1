...
/*       Rapor gönderilecek mail adreslerini çek       */    
     ...
     $sql_mail = "SELECT EMAIL AS TO_EMAIL, ACCOUNT_NO from ACCOUNT_EMAIL WHERE EMAIL <>'' LIMIT 0,50";
...
#function writeToFile($email)
 #    $filename = dirname($DOCUMENT_ROOT).'/mails.txt';
  #   $somecontent = "$email\n";
