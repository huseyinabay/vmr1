...
//////////////////////Auth code control ////////////////////////////      
   ...
   $sql_str  = "SELECT  ACCOUNT_NO, EXT_NO, PRICE, DATE_FORMAT(CDR_MAIN_DATA.MY_DATE,\"%d/%m\") AS TXTMY_DATE,
...
#AUTH   CODE LARA GÖRE RAPOR ALMAK ÝÇÝN
   ...
   $sql_str_a  = "SELECT  ACCOUNT_NO, AUTH_ID, PRICE, DATE_FORMAT(CDR_MAIN_DATA.MY_DATE,\"%d/%m\") AS TXTMY_DATE,
