<?php
  ...
  $titleObj = $c->addTitle(turkish2utf(" Bölgelere Göre Tutar Dağılımı\n"),"verdana.ttf" ,13,0xFFFFFF);
  ...
  $c->yAxis->setTitle(" Tutar ( Bin )","verdana.ttf",10,0x000000);
  ...
  $dataSetObj = $layer->addDataSet($data[$tlast], 0xc0, turkish2utf($gecen));
  $dataSetObj->setDataSymbol(DiamondSymbol, 9, 0xffff00);
  $dataSetObj = $layer->addDataSet($data[$tprev], 0x982810, turkish2utf($onceki));
