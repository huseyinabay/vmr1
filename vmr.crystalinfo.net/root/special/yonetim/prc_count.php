<?php
  ...
  $title = turkish2utf(strftime("%B %Y", mktime(0, 0, 0, $row['TIME_STAMP_MONTH']-1,32, $row['TIME_STAMP_YEAR']))." Tutar Dağılımı ");
  ...
  $note = turkish2utf(strftime("%B %Y", mktime(0, 0, 0, $row['TIME_STAMP_MONTH']-1,32, 04))." Görüşme Tutarınız\n".write_price($total)." YTL'dir");
