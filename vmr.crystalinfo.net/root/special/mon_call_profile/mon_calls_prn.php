<?
   ...
   if (right_get("SITE_ADMIN")){
     ...
     print_error("Bu sayfayı görme yetkiniz yoktur.");
   }
    ...
    if ($act == "src") {
       ...
       switch ($type) {
        ...
        case 'dept';
          ...
          else{echo "Hatalı Durum Oluştu";exit;}
        ...
        case 'ext';
          ...
          $header_text = "DAHİLİ BAZINDA : ".$ORIG_DN." - ".get_ext_name2($ORIG_DN, $SITE_ID);
          break;
        default:
          echo "Hatalı Durum Oluştu";exit;
         }
       ...
       //Tarih kriterleri (Voip çağrıları için)
    ...
    <td width="100%" align="center" class="rep_header" align="center">
      <TABLE BORDER="0" WIDTH="100%">
        <TR>
          ...
          <TD width="50%" align=center CLASS="header"><?echo $company;?><BR>AYLIK ÇAĞRI PROFİLİ<br><BR><?=get_site_name($SITE_ID)?></TD>
  ...
  <tr>
    <td>
      <table width="100%" border="0" bgcolor="#C7C7C7" cellspacing="1" cellpadding="0">
          <tr>
              <td class="rep_table_header" width="15%">Giden Çağrılar</td>
...
<?
        ...
        <tr  BGCOLOR="E4E4E4">
          <td class="rep_td">Şehirler Arası</td>
<?
...
<?
        ...
        <tr  BGCOLOR="E4E4E4">
          <td class="rep_td">Uluslar Arası</td>
<?
...
<?        if (!($cdb->execute_sql($sql_voip, $rsltVoip, $error_msg))){
          ...
          $row_voip = mysqli_fetch_object($rsltVoip);
        ...
        <tr  BGCOLOR="E4E4E4">
          <td class="rep_td">Diğer</td>
<?
          echo " <td class=\"rep_td\">".calculate_all_time($row->OTH_DUR-$row_voip->DURATION)."</td>";
          echo " <td class=\"rep_td\">".number_format($row->OTH_AMOUNT-$row_voip->AMOUNT,0,'','.')."</td>";
...
<?        
        ...
        <tr>
          ...
          <tr>
              <td class="rep_table_header" width="15%">Gelen Çağrılar</td>
              <td class="rep_table_header" width="35%">Süre</td>
              <td class="rep_table_header" width="25%">Adet</td>
              <td class="rep_table_header" width="25%">Ücret</td>
          </tr>
...
<?        
        ...
        <tr>
          ...
          <tr>
              <td class="rep_table_header" width="15%">Dahili Çağrılar</td>
              <td class="rep_table_header" width="35%">Süre</td>
              <td class="rep_table_header" width="25%">Adet</td>
              <td class="rep_table_header" width="25%">Ücret</td>
          </tr>
