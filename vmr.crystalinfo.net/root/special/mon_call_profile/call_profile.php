...
/*                  $DATA1 .=      "<td class='td1_koyu' colspan='3' width='30%' align='center'>Site Adı&nbsp;&nbsp;&nbsp; 
             ...
             <table border=0 width=70% height=20%>
               <tr>
                <td><a href=\"http://www.crystalinfo.net\" target=\"_blank\"><img border=0 SRC=\"http://".$server_ip.IMAGE_ROOT."logo2.gif\"></a></TD>
                 <td align=center class=header>".$row_site->SITE_ID." - ".$row_site->SITE_NAME."<br><br>Aylık Telefon Çağrı Profili<br><br>
                 Departman Adı : ".get_dept_name($row_dept->DEPT_ID,$row_site->SITE_ID)."<br><br>".
...
/*          GÖRÜŞME ÜCRETLERİ         */            
            $DATA1.= "<tr bgcolor='#FFCC00' height=20><td colspan=9 align=center><b>Görüşme Ücretleri</b></td>
                      </tr>";
            $DATA1 .= "<tr bgcolor=\"#88ACD5\" class='rep2_header' height='22' align=center>
		              <td width='28%'></td>
		              <td width='9%'>Ş. İçi</td>
		              <td width='9%'>Ş Arası</td>
	                  <td width='9%'>GSM</td>
		              <td width='9%'>U. Arası</td>
		              <td width='9%'>Diğer</td>
...
/*          GÖRÜŞME ÜCRETLERİ SONU                        */

/*          GÖRÜŞME ADETLERİ        */            
            $DATA1.= "<tr bgcolor='#FFCC00' height=20><td colspan=9 align=center><b>Görüşme Adetleri</b></td>
                      </tr>";
            $DATA1 .= "<tr bgcolor=\"#88ACD5\" class='rep2_header' height='22' align=center>
		              <td width='28%'></td>
		              <td width='9%'>Ş. İçi</td>
...
/*          GÖRÜŞME ADETLERİ SONU                        */

/*          GÖRÜŞME SÜRELERİ                        */
            $DATA1.= "<tr bgcolor='#FFCC00' height=20><td colspan=9 align=center><b>Görüşme Süreleri</b></td>
                      </tr>";
            $DATA1 .= "<tr bgcolor=\"#88ACD5\" class='rep2_header' height='22' align=center>
		              <td></td>
		              <td>Ş. İçi</td>
