...
?>
  ...
  <?
    ...
    if ($act == "src") {
       ...
       //Temel kriterler verinin hızlı gmesi icin basa konuldu.
    ...
    <td width="100%" align="center" class="rep_header" align="center">
      <TABLE BORDER="0" WIDTH="100%">
        <TR>
          ...
          <TD width="50%" align=center CLASS="header"><?echo $company;?><BR>GELEN ÇAĞRI RAPORU<br><BR><?=get_site_name($SITE_ID)?></TD>
      ...
      $m =0;
		for($i=0;$i < sizeof($arr_data);$i++){
		  ...
		  next($arr_data);
            ...
            $m++;
            $csv_data[$m][2] = "Toplam Görüşme Adedi";
