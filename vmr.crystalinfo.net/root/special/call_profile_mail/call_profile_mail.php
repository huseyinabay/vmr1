...
/*       Rapor gönderilecek mail adreslerini çek       */    
    ...
    while($rw_mail = mysqli_fetch_object($res_mail)){
      ...
      if (!($cdb->execute_sql($sql_rep, $res_rep, $error_msg))){
        ...
        $report_name = "AYLIK ÇAĞRI PROFİLİ";
        $DATA_HEADER ="
        <html>
        <head>
        ...
        <table width=\"1000\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
          ...
          <tr>
            ...
            <table border=\"0\"  width=100% bgcolor=\"#C7C7C7\" cellspacing=\"1\" cellpadding=\"0\">
               <tr>
                  <td class=\"rep_table_header\" rowspan=2 align=center width=\"200\">Açıklama</td>
      ...
      while($rw_rep = mysqli_fetch_object($res_rep)){
    ...
    if($DATA !=""){
      ...
      //mail_send($email,"AYLIK ÇAĞRI PROFİLİ",$DATA);
