...
//Site Admin Hakkı Yoksa sadece kendisine bağlı kayıtları görsün   
   ...
   if($act=="save" &&  is_numeric($id)){
      ...
      if(exist_mail_status($str_sql)){
         print_error("Buna benzer bir kayıt daha önce girilmiş. İkinci kez giremezsiniz...");
      }
...
?>
   ...
   <table cellpadding="0" cellspacing="0" border="0" width="80%" align="center">
        <tr>
           <td width="40%" class="td1_koyu">Site Adı</td>
            <td>
            ...
            alert("Lütfen email adresini girin!");
              ...
              if(document.all('REP_TYPE').value == -1){
                ...
                if(document.all('EXT_NO').value == ''){
                  alert("Lütfen Bir Dahili Numarası Girin");
                }else{
                  document.all(form_name).submit();
                }
