<?  require_once $_SERVER['DOCUMENT_ROOT']."/cgi-bin/functions.php";
    ...
    //AUth Code kontrölü
    $sql_str="SELECT USERNAME,PASSWORD FROM USERS WHERE USERNAME='".$_SESSION["username"]."' AND PASSWORD=PASSWORD('".$AUTH_CODE."')"; 
    //echo $sql_str;exit;
    ...
    if (!mysqli_num_rows($result)>0){
          cc_page_meta();
          echo "<center><br>\n";
          echo("Bu Otorizasyon kodu size ait değil gözüküyor. Lütfen sistem yöneticinize başvurunuz.<br><br>\n");
