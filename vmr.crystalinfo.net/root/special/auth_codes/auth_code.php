...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
      ...
      <center>
            <table class="formbg">
            <form name="auth_code_frm" method="post" onsubmit="return check_form(this);" action="auth_code_db.php?act=<? echo  $_GET['act'] ?>">
           ...
           <tr class="form">
              ...
              <tr class="form">
               ...
               <tr class="form">
                  <td class="td1_koyu">Ayrıntılı Döküm</td>
  ...
  <table align="right" width="100%" border="0">
    ...
    <script language="javascript">
      form_fields[0] = Array ("SITE_ID",   "Authorizasyon Kodunun Bağlı Olduğu Siteyi Seçiniz.", TYP_DROPDOWN);            
