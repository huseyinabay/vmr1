...
//SEYKAY
  ...
  //SEYKAY
   ...
   // OKOC Maximum yıl içinde bulunduğumuz yılın 3 fazlası olacak şekilde ayarlanmıştır.
  ...
  this.wwrite("</TD><td xbackground=\"/images/takvim05.gif\" rowspan=3><imgz src=\"images/takvim05.gif\" width=6 height=2></td>");   
   ...
   if (this.gWtime==true)
    ...
    this.wwrite("<script language=\"javascript\">\n"+
                ...
                "      }else{ \n" +
                "        alert('Girdiğiniz Zaman Formatı Yanlış');return}\n"+    
                "  }else{ " +
...
function Build(p_item, p_month, p_year, p_format,pWtime) {
    ...
    var maxYearObj = new Date();
   // OKOC Maximum yıl içinde bulunduğumuz yılın 1 fazlası olacak şekilde ayarlanmıştır.
