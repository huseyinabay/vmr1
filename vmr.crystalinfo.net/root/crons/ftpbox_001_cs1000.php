<?php
$ftp_server = "10.45.9.25";
$ftp_user_name = "cdr";
$ftp_user_pass = "Netser88+.";
...
//         }	    
	...
	fwrite($handle2, $buffer);    
        if(strlen($buffer)>2){
           $sqlQuery =  "\n INSERT INTO RAW_DATA(DATA, DATE, SOURCE, SITE_ID,ERROR_CODE) VALUES ('".$buffer."',CURDATE(),'cs1000',2, '0')";
   	   //echo $sqlQuery;
