<?
  ...
  while($row = mysqli_fetch_object($result)){
    ...
    //////////////////////////////////////////////////////////////
    $sql1 = "SELECT CDR_MAIN_INB.SITE_ID, CDR_ID, EXTENTIONS.EMAIL, TIME_STAMP, CHG_INFO, CLID, TER_DN, EXTENTIONS.DESCRIPTION AS DES, E.DESCRIPTION as EDES 
			 FROM CDR_MAIN_INB
             LEFT JOIN EXTENTIONS ON EXTENTIONS.EXT_NO = CDR_MAIN_INB.TER_DN
             LEFT JOIN EXTENTIONS as E ON E.EXT_NO = CDR_MAIN_INB.CLID
             AND EXTENTIONS.SITE_ID = CDR_MAIN_INB.SITE_ID            
  ...
  $sql2 = "UPDATE ALERT_DEFS SET LAST_PROC_ID = '$LAST_PROC_ID' WHERE ALERT_DEF_ID = '$ALERT_DEF_ID'" ; 
