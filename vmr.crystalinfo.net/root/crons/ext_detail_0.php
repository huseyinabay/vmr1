  ...
  while($row = mysql_fetch_object($rs)){//Bütün siteler taranmalý Site döngüsü start
        ...
        <table width=\"65%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
          <tr>
            ...
            <TABLE BORDER=\"0\" WIDTH=\"100%\">
              <TR>
                ...
                <TD width=\"50%\" align=center CLASS=\"header\">".$SITE_NAME . "<BR>Aylýk GENEL ARAMA(0) Dahili Raporu<br><STRONG>Dönem</STRONG> : <!-- DONEM --></TD>
          ...
          <tr>
            ...
            <table border=\"0\"  width=100% bgcolor=\"#C7C7C7\" cellspacing=\"1\" cellpadding=\"0\">
              <tr>
	        <!--<td align=center class=\"rep_table_header\" width=\"30%\">Erisim Kodu</td>-->
	...
	$QRY = "SELECT * FROM EXTENTIONS WHERE (EMAIL<>'' AND INSTR(EMAIL,'@')) AND SITE_ID = ".$SITE_ID;
	  ...
	  if($EXT_NO != ""){
          ...
          $kriter .= $cdb->field_query($kriter,   "ACCESS_CODE"     ,  "<>",  "66"); //sirket  aramalarin erisim kodudur
